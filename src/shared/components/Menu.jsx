    ...
    return (
        ...
        <div style={{ marginTop: '20px', marginLeft: '10%', marginRight: '10%' }}>
            ...
            <div className="megamenu max-sm:megamenu-vertical p-2 border border-emerald-100 bg-emerald-50 rounded-box shadow-lg" id="main-menu" popover="auto">
                ...
                <button popoverTarget="menu-categoria-produto"> <strong> Categoria de Produto </strong> </button>
                <div id="menu-categoria-produto" popover="auto">
                    <ul className="menu">
                        <li><a href="/categoriaproduto">Listar</a></li>
                        <li><a href="/categoriaproduto-form">Cadastrar</a></li>
                    </ul>
                </div>
